...
const STEPS = {
  fr: [
    ...
    { n: "3", icon: "✅", title: "Xalifly décide pour vous", desc: "MILES WIN, IF YOU HAVE MILES ou CASH WINS — clair, sans ambiguïté." },
  ],
  en: [
    ...
    { n: "3", icon: "✅", title: "Xalifly decides for you", desc: "MILES WIN, IF YOU HAVE MILES or CASH WINS — clear, unambiguous." },
  ],
};
