...
export default async function Image({ params }: Props) {
  ...
  const fromCity = fromAirport?.cityEn ?? fromAirport?.city ?? from;
  const toCity = toAirport?.cityEn ?? toAirport?.city ?? to;
  ...
  return new ImageResponse(
    ogWrapper(
      <>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginTop: 8 }}>
            {cheapestPrice !== null && (
              <div style={{
                ...
                <span style={{ color: "#10b981", fontSize: 13, fontWeight: 700 }}>From</span>
        ...
        {ogBottomBar("Cash vs miles · 46 loyalty programs · updated daily")}
      </>
    ),
