 ...
 *
 * Amadeus provider health check endpoint.
...
export async function GET(req: NextRequest): Promise<NextResponse> {
  ...
  try {
    const metrics = await redis.get<AmadeusErrorMetrics>(AMADEUS_ERROR_TRACKING_KEY);
