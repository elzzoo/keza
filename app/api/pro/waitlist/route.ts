...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    resend.emails.send({
      from: FROM_EMAIL,
      to: email,
      subject: "✅ Tu es sur la liste d'attente Xalifly Pro",
      html: `
        <div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;max-width:500px;margin:0 auto;background:#0a0a0f;color:#e2e8f0;border-radius:16px;overflow:hidden;">
          <div style="background:linear-gradient(135deg,#1e3a5f,#0a0a1a);padding:24px;text-align:center;">
            <h1 style="margin:0;font-size:24px;"><span style="color:#3b82f6;">Xali</span><span style="color:#e2e8f0;">fly</span> <span style="color:#f59e0b;font-size:18px;">Pro</span></h1>
          </div>
          <div style="padding:24px;">
            ...
            <p style="margin:0 0 16px;font-size:14px;color:#94a3b8;">
              On te contactera en priorité dès que Xalifly Pro est disponible.<br/>
            ...
            <div style="background:#1a1a2e;border-radius:12px;padding:16px;margin-bottom:16px;">
              <p style="margin:0;font-size:13px;color:#64748b;">Ce qui t'attend avec Xalifly Pro :</p>
